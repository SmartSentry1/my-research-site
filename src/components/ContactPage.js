...
const teamMembers = [
  {
    ...
    image: process.env.PUBLIC_URL + "/Narmada-Gamage-2.webp",
  ...
  },
  {
    ...
    description: "Computer Systems Engineering - SLIIT",
    image: process.env.PUBLIC_URL + "/ravitha.webp", // replace with actual path
  },
  {
    name: "Ekanayake J.S.P.A",
    role: "IT20108922",
    description: "Computer Systems Engineering - SLIIT",
    image: process.env.PUBLIC_URL + "/sadev.webp", // replace with actual path
  },
  {
    name: "M.M.S Silva",
    role: "IT20383770",
  ...
  },
  {
    ...
    role: "IT20182182",
    description: "Computer Systems Engineering - SLIIT",
    image: process.env.PUBLIC_URL + "/ravindu.webp", // replace with actual path
  },
];
const AboutPage = () => {
  return (
